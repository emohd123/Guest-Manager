  ...
  return (
    <View style={styles.shell}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.livePill}><View style={styles.liveDot} /><Text style={styles.liveText}>Discover Bahrain</Text></View>
      </View>
