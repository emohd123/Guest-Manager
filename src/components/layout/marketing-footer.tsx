...
export function MarketingFooter() {
  return (
    <footer className="relative z-20 border-t border-slate-200 bg-white text-slate-900 backdrop-blur-xl">
      <div className="mx-auto max-w-none px-4 py-16 sm:px-8 lg:px-12 2xl:px-20">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div dir="ltr" className="lg:col-span-2">
            <Link href="/" aria-label="iTicket home">
              <BrandWordmark
                ...
                textClassName="text-[2.1rem] text-slate-950 sm:text-[2.6rem]"
              />
            </Link>
            <a
              ...
              className="mt-2 inline-block text-[10px] font-black uppercase tracking-[0.24em] text-slate-500 transition-colors hover:text-cyan-700"
            >
              A OneStone Platform
            </a>
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h4 className="mb-3 text-sm font-semibold text-slate-950">{category}</h4>
