  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-primary/50 focus-visible:ring-primary/30 focus-visible:ring-2 focus-visible:shadow-[0_0_15px_rgba(255,91,106,0.2)] focus-visible:bg-card dark:focus-visible:bg-white/10",
