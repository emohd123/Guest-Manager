  ...
  return (
    <div className="space-y-12 pb-20 px-2">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        >
          <h1 className="text-4xl font-black text-foreground dark:text-white italic tracking-tighter uppercase">Dashboard</h1>
      ...
      <div className="grid gap-10 lg:grid-cols-3">
        ...
        <div className="space-y-10 lg:col-span-2">
          ...
          >
            <div className="p-8 border-b border-border dark:border-white/5 flex items-center justify-between bg-muted/30 dark:bg-white/2 backdrop-blur-xl">
              <div>
                <h3 className="text-xl font-black text-foreground dark:text-white italic leading-none mb-2">Upcoming Events</h3>
                <p className="text-muted-foreground dark:text-white/30 text-[10px] font-bold uppercase tracking-widest">Your next published events</p>
              </div>
              ...
              {upcomingLoading ? (
                ...
                <div className="p-16 text-center space-y-6">
                  ...
                  <div className="space-y-2">
                    <h4 className="text-lg font-black text-foreground dark:text-white italic uppercase tracking-tighter">No Published Events</h4>
                    <p className="text-muted-foreground/70 dark:text-white/20 text-[10px] font-bold uppercase tracking-widest">Create an event to get started</p>
                  </div>
                  <Link href="/dashboard/events/new">
        ...
        <div className="space-y-10">
          ...
          >
            <h3 className="text-lg font-black text-foreground dark:text-white italic uppercase tracking-tighter ml-2">Quick Actions</h3>
          ...
          >
            ...
            <h3 className="text-lg font-black text-foreground dark:text-white italic uppercase tracking-tighter">Recent Activity</h3>
              ...
              <div className="space-y-6">
                <div className="flex gap-4 items-start group">
                   ...
                   <div className="space-y-1">
                      <p className="text-sm font-black text-foreground dark:text-white italic">{totalCheckIns} check-ins recorded</p>
                      <p className="text-[10px] font-bold text-muted-foreground/70 dark:text-white/20 uppercase tracking-widest">Live across your events</p>
                   </div>
                </div>
              </div>
            ) : (
          ...
          >
            <div className="relative z-10 space-y-6">
               <div className="flex items-center justify-between">
                 <h3 className="text-xl font-black text-foreground dark:text-white italic tracking-tighter uppercase leading-none">Plan Usage</h3>
                 <Badge className="bg-primary text-white font-black text-[9px] uppercase border-none px-3">BASIC</Badge>
               </div>
               
               <div className="space-y-4">
                 <div className="flex justify-between items-end">
                    <p className="text-[10px] font-black text-muted-foreground dark:text-white/40 uppercase tracking-widest">Check-in Credits</p>
