    ...
    <div className="space-y-12 pb-20 px-2">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }}>
          <h1 className="text-4xl font-black text-foreground dark:text-white italic tracking-tighter uppercase leading-none">Relay</h1>
        ...
        <Dialog open={createOpen} onOpenChange={handleClose}>
          ...
          <DialogContent className="sm:max-w-2xl bg-popover dark:bg-slate-950 border-border dark:border-white/10 text-popover-foreground rounded-[40px] shadow-2xl p-0 overflow-hidden">
            <div className="p-10 space-y-8 max-h-[85vh] overflow-y-auto custom-scrollbar">
              <DialogHeader>
                <DialogTitle className="text-3xl font-black text-foreground dark:text-white italic tracking-tighter uppercase leading-none mb-2">Initialize Payload</DialogTitle>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
                  <div className="space-y-6">
                    <div className="space-y-3">
                      <Label className="text-[10px] font-black text-muted-foreground dark:text-white/40 uppercase tracking-widest ml-1">Deployment Identifier</Label>
                      <Input className="h-14 rounded-2xl bg-card border-border text-foreground dark:bg-white/5 dark:border-white/10 dark:text-white font-black italic uppercase tracking-widest text-[10px] focus:ring-primary" placeholder="e.g., GALA_DISPATCH_v1" />
                    </div>
                    <div className="space-y-3">
                      <Label className="text-[10px] font-black text-muted-foreground dark:text-white/40 uppercase tracking-widest ml-1">Subject Frequency</Label>
                      <Input className="h-14 rounded-2xl bg-card border-border text-foreground dark:bg-white/5 dark:border-white/10 dark:text-white font-black italic uppercase tracking-widest text-[10px] focus:ring-primary" placeholder="Your Operational Assets Inside" />
                    </div>
                    <div className="grid gap-6 sm:grid-cols-2">
                       <div className="space-y-3">
                          <Label className="text-[10px] font-black text-muted-foreground dark:text-white/40 uppercase tracking-widest ml-1">Target Operation</Label>
                       ...
                       <div className="space-y-3">
                          <Label className="text-[10px] font-black text-muted-foreground dark:text-white/40 uppercase tracking-widest ml-1">Dispatch Audience</Label>
                    ...
                    <div className="space-y-3">
                      <Label className="text-[10px] font-black text-muted-foreground dark:text-white/40 uppercase tracking-widest ml-1">Payload Content</Label>
                      <Textarea className="rounded-3xl bg-card border-border text-foreground dark:bg-white/5 dark:border-white/10 dark:text-white font-black italic uppercase tracking-widest text-[10px] focus:ring-primary min-h-[150px] p-6" placeholder="Initialize data string..." />
                    </div>
                  </div>
                  <div className="flex justify-between pt-4 border-t border-border dark:border-white/5">
                    <Button variant="ghost" className="h-14 px-8 rounded-2xl text-muted-foreground dark:text-white/20 hover:text-foreground dark:hover:text-white font-black italic uppercase tracking-widest text-[10px]" onClick={() => setSelectedTemplate(null)}>REVERT</Button>
                    <div className="flex gap-4">
                      <Button variant="outline" className="h-14 px-8 rounded-2xl bg-card border-border text-foreground dark:bg-white/5 dark:border-white/10 dark:text-white font-black italic uppercase tracking-widest text-[10px] flex gap-3 hover:bg-muted dark:hover:bg-white/10"><Clock className="h-4 w-4" /> AUTO-DELAY</Button>
        ...
        <TabsContent value="campaigns" className="mt-0 outline-none">
          <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="rounded-[40px] bg-card/90 dark:bg-white/5 border border-border dark:border-white/10 overflow-hidden">
            <div className="p-8 border-b border-border dark:border-white/5 bg-muted/30 dark:bg-white/2 flex items-center justify-between">
               <div>
                  <h3 className="text-xl font-black text-foreground dark:text-white italic leading-none mb-2">Relay Stream</h3>
                  <p className="text-muted-foreground dark:text-white/30 text-[10px] font-bold uppercase tracking-widest">Active and archived transmissions</p>
               </div>
            </div>
            <div className="p-24 text-center space-y-8">
              ...
              <div className="space-y-2">
                <h4 className="text-2xl font-black text-foreground dark:text-white italic uppercase tracking-tighter leading-none">Transmission Silence</h4>
