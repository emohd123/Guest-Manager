...
export default function FormResponsesPage() {
  ...
  const columns = [
    ...
    },
    {
      id: "details",
      header: "Details",
      cell: () => <span className="font-black italic text-primary uppercase text-[10px] tracking-widest cursor-pointer hover:underline">VIEW RESPONSE</span>,
    }
  ];
  ...
  return (
    <div className="space-y-12 pb-20 px-2">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        >
          <h1 className="text-4xl font-black text-white italic tracking-tighter uppercase leading-none">Form Responses</h1>
