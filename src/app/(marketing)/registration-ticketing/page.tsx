  ...
  return (
    <div className="bg-[#f6f7fb] text-slate-900 min-h-screen">
          ...
          <div className="bg-white p-8">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h3 className="mt-3 text-2xl font-bold text-slate-900">Annual Tech Conference 2026</h3>
                <p className="mt-1 text-slate-600 text-sm">March 15, 2026 · Convention Center, Bahrain</p>
              </div>
              <Button className="bg-[linear-gradient(135deg,#7c3aed,#db2777)] text-slate-900 border-0 font-bold rounded-full shrink-0">
                Register Now
              </Button>
            </div>
            <div className="mt-6 grid gap-3 md:grid-cols-3">
              {[
                ...
                <div key={ticket.label} className="rounded-xl border border-slate-200 bg-white p-4">
                  <p className="font-semibold text-slate-900 text-sm">{ticket.label}</p>
                  <p className="text-2xl font-black text-purple-400 mt-1">{ticket.price}</p>
                  <p className="text-xs text-slate-500 mt-1">{ticket.available}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="group border border-white/5 bg-white backdrop-blur-xl rounded-2xl p-6 hover:border-slate-200 hover:-translate-y-1 hover:bg-white transition-all duration-300"
              >
      ...
      <section className="mx-auto max-w-4xl px-4 py-20 sm:px-6 lg:px-8">
        <h2 className="mb-12 text-center text-4xl font-black uppercase tracking-tighter text-slate-900">
      ...
      <section className="border-t border-white/5 bg-white px-4 py-20">
        <div className="mx-auto max-w-3xl">
          <h2 className="mb-10 text-center text-4xl font-black uppercase tracking-tighter text-slate-900">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={point} className="flex items-center gap-3 rounded-xl border border-white/5 bg-white p-4 hover:border-slate-200 hover:bg-white transition-all duration-200">
      ...
      <section className="px-4 py-24 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <p className="mt-4 text-slate-600 text-lg">Create your first event page in minutes. Free to start.</p>
