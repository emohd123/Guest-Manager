  ...
  const events: MarketplaceEvent[] = [
    {
      ...
      venueName: "Bahrain Harbour",
      locationText: "Manama, Bahrain",
      // Keep local fallback cards on the same public event route as production.
      publicUrl: "/e/demo-events-co/bahrain-summer-beats",
      buyUrl: "/e/demo-events-co/bahrain-summer-beats#tickets",
    ...
    },
    {
      ...
      category: "Family",
      categorySlug: "family",
      venueName: "Bahrain International Exhibition Centre",
      locationText: "Sakhir, Bahrain",
      publicUrl: "/e/demo-events-co/family-fun-day",
      buyUrl: "/e/demo-events-co/family-fun-day#tickets",
      registrationEnabled: true,
      hasTickets: true,
    ...
    },
    {
      ...
      locationText: "Manama, Bahrain",
      publicUrl: "/e/demo-events-co/bahrain-comedy-night",
      buyUrl: "/e/demo-events-co/bahrain-comedy-night#tickets",
      registrationEnabled: true,
      hasTickets: true,
