  ...
  return (
    <div className="bg-[#f6f7fb] text-slate-900 min-h-screen">
      ...
      <section className="mx-auto max-w-3xl px-4 pb-20 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-8 shadow-2xl">
          <div className="mx-auto max-w-md space-y-4">
            {/* Check-in screen preview */}
            <div className="rounded-xl border border-slate-200 bg-[#111320] p-4 shadow-lg">
              <div className="mb-4 flex items-center justify-between">
                <h3 className="font-bold text-slate-900 text-sm uppercase tracking-wider">Check-In</h3>
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400" />
                  <span className="font-bold text-slate-900">156</span>
                  <span className="text-slate-500">/</span>
                  <span className="font-bold text-slate-600">243</span>
              ...
              <div className="relative mb-4">
                ...
                <div className="h-10 rounded-lg border border-slate-200 bg-white pl-10 pt-2 text-sm text-slate-500">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">{guest.table}</p>
                      </div>
                    </div>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1 text-[10px] font-black uppercase tracking-[0.2em] text-slate-600 mb-4">
            Features
          </div>
