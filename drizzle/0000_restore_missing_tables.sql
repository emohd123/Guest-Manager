...
CREATE TYPE "public"."attendance_state" AS ENUM('not_arrived', 'checked_in', 'checked_out');--> statement-breakpoint
...
CREATE TYPE "public"."scan_method" AS ENUM('scan', 'search', 'manual', 'walkup');--> statement-breakpoint
...
CREATE TYPE "public"."paired_via" AS ENUM('code_pin', 'qr', 'staff');--> statement-breakpoint
CREATE TYPE "public"."import_status" AS ENUM('pending', 'processing', 'completed', 'failed');--> statement-breakpoint
CREATE TYPE "public"."device_command_status" AS ENUM('pending', 'ack', 'expired');--> statement-breakpoint
CREATE TYPE "public"."device_command_type" AS ENUM('ping');--> statement-breakpoint
...
CREATE TABLE "events" (
	...
	CONSTRAINT "events_visitor_code_unique" UNIQUE("visitor_code")
);
--> statement-breakpoint
CREATE TABLE "venues" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE "guests" (
	...
	"attendance_state" "attendance_state" DEFAULT 'not_arrived' NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "scans" (
	...
	"method" "scan_method" DEFAULT 'scan' NOT NULL,
	"barcode" varchar(255),
	"result" varchar(50),
	"notes" text,
...
CREATE TABLE "devices" (
	...
	"scanner_battery" integer,
	"scanner_charge_state" varchar(40),
	"onsite_pin" varchar(10),
...
--> statement-breakpoint
CREATE TABLE "event_device_access" (
...
--> statement-breakpoint
CREATE TABLE "mobile_mutation_dedup" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"device_id" text NOT NULL,
	"event_id" uuid NOT NULL,
...
ALTER TABLE "scans" ADD CONSTRAINT "scans_device_id_devices_id_fk" FOREIGN KEY ("device_id") REFERENCES "public"."devices"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "devices" ADD CONSTRAINT "devices_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "data_imports" ADD CONSTRAINT "data_imports_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "event_device_access" ADD CONSTRAINT "event_device_access_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "event_device_access" ADD CONSTRAINT "event_device_access_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "device_pair_tokens" ADD CONSTRAINT "device_pair_tokens_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "device_pair_tokens" ADD CONSTRAINT "device_pair_tokens_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "device_pair_tokens" ADD CONSTRAINT "device_pair_tokens_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "device_commands" ADD CONSTRAINT "device_commands_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "mobile_mutation_dedup" ADD CONSTRAINT "mobile_mutation_dedup_device_id_devices_id_fk" FOREIGN KEY ("device_id") REFERENCES "public"."devices"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mobile_mutation_dedup" ADD CONSTRAINT "mobile_mutation_dedup_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sent_emails" ADD CONSTRAINT "sent_emails_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "events_company_slug_idx" ON "events" USING btree ("company_id","slug");--> statement-breakpoint
CREATE UNIQUE INDEX "event_device_access_access_code_idx" ON "event_device_access" USING btree ("access_code");--> statement-breakpoint
CREATE UNIQUE INDEX "mobile_mutation_dedup_device_mutation_idx" ON "mobile_mutation_dedup" USING btree ("device_id","client_mutation_id");